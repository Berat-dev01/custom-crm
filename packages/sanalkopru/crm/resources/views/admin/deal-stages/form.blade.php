...
@section('title', $stage->exists ? 'Edit Deal Stage' : 'New Deal Stage')
@section('page-title', $stage->exists ? 'Edit Deal Stage' : 'New Deal Stage')
...
@section('content')
    <section class="crm-admin-page" data-crm-module="deal-stages">
        <header class="crm-admin-header crm-admin-header-row">
            <div>
                <p class="crm-admin-eyebrow">CRM / Deal Stages</p>
                <h1>{{ $stage->exists ? 'Edit Deal Stage' : 'New Deal Stage' }}</h1>
            </div>
            ...
            >
                ...
                <div class="crm-form-actions crm-span-2">
                    <x-admin-panel::button type="submit" icon="save">
                        {{ $stage->exists ? 'Save Stage' : 'Create Stage' }}
                    </x-admin-panel::button>
